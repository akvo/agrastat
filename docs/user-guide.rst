...
This user guide covers using AGRASTAT's web interface to organize, publish and find
data. AGRASTAT also has a powerful API (machine interface), which makes it easy to
